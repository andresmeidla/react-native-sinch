...
public class RNSinchModule extends ReactContextBaseJavaModule {

    private ReactApplicationContext mContext;
    private Verification mVerification;
    private Callback mCallback;
	
    public RNSinchModule(ReactApplicationContext context) {
        super(context);
        mContext = context;
    }

    public String getName() {
        return "RNSinchAndroid";
    }
